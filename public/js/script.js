        ...
        if (events.length > 0) {
            ...
            if (part_V.length > 0) {
                ...
                for (let i = 0; i < part_V.length; i++) {
                    ...
                    text_test += '   <Row ss:AutoFitHeight="0" ss:Height="15.75">\n' +
                        ...
                        '    <Cell ss:StyleID="s39"><Data ss:Type="String">detail</Data></Cell>\n' +
                        '    <Cell ss:StyleID="s38"><Data ss:Type="Number">' + object.duration + '</Data></Cell>\n' +
                        '    <Cell ss:StyleID="s39"><Data ss:Type="String">Commentaire</Data></Cell>\n' +
                        '    <Cell ss:StyleID="s23"/>\n' +
                        '    <Cell ss:StyleID="s33"/>\n' +
                        '    <Cell ss:StyleID="s33"/>\n' +
                        '    <Cell ss:StyleID="s33"/>\n' +
            ...
            if (part_M.length > 0) {
                ...
                for (let i = 0; i < part_M.length; i++) {
                    ...
                    text_test += '   <Row ss:AutoFitHeight="0" ss:Height="15.75">\n' +
                        ...
                        '    <Cell ss:StyleID="s39"><Data ss:Type="String">detail</Data></Cell>\n' +
                        '    <Cell ss:StyleID="s38"><Data ss:Type="Number">' + object.duration + '</Data></Cell>\n' +
                        '    <Cell ss:StyleID="s47"><Data ss:Type="String">OUI</Data></Cell>\n' +
                        '    <Cell ss:StyleID="s23"/>\n' +
                        '    <Cell ss:StyleID="s33"/>\n' +
                        '    <Cell ss:StyleID="s33"/>\n' +
                        '    <Cell ss:StyleID="s33"/>\n' +
            ...
            for (let i = 0; i < part_AV.length; i++) {
                ...
                text_test += '   <Row ss:AutoFitHeight="0" ss:Height="15.75">\n' +
                    ...
                    '    <Cell ss:MergeAcross="1" ss:StyleID="m140462106055528"><Data ss:Type="String">Commentaire</Data></Cell>\n' +
                    '    <Cell ss:StyleID="s33"/>\n' +
                    '    <Cell ss:StyleID="s33"/>\n' +
                    '    <Cell ss:StyleID="s33"/>\n' +
                    '    <Cell ss:StyleID="s33"/>\n' +
            ...
            createDownloader('test.xml', text_test, div_full);
